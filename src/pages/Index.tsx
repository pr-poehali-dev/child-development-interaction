...
const Index = () => {
  ...
  const articles = [
    ...
    },
    {
      id: 2,
      category: '3-7 лет',
      title: 'Истерики и капризы: что делать родителям',
      excerpt: 'Почему дети устраивают истерики и как правильно на них реагировать, не теряя спокойствия.',
      icon: 'AlertCircle'
    },
    {
      id: 3,
      category: '3-7 лет',
      title: 'Развитие самостоятельности в дошкольном возрасте',
      excerpt: 'Какие навыки можно и нужно развивать у детей 3-7 лет. Как поддержать самостоятельность без давления.',
      icon: 'Star'
    },
    {
      id: 4,
      category: '3-7 лет',
      title: 'Игра как главный способ обучения',
      excerpt: 'Почему игра важнее ранней подготовки к школе и как играть с пользой для развития ребенка.',
      icon: 'Sparkles'
    },
    {
      id: 5,
      category: '3-7 лет',
      title: 'Детские страхи: темнота, монстры, разлука',
      excerpt: 'Возрастные страхи дошкольников и эффективные способы помочь ребенку их преодолеть.',
      icon: 'Moon'
    },
    {
      id: 6,
    ...
    },
    {
      id: 7,
      category: '7-12 лет',
      title: 'Мотивация к учебе: как помочь без давления',
      excerpt: 'Почему дети теряют интерес к школе и как родители могут поддержать внутреннюю мотивацию.',
      icon: 'BookOpen'
    },
    {
      id: 8,
      category: '7-12 лет',
      title: 'Как научить ребенка дружить',
      excerpt: 'Социальные навыки младших школьников: как помочь находить друзей и решать конфликты.',
      icon: 'Heart'
    },
    {
      id: 9,
      category: '7-12 лет',
      title: 'Ответственность и самоорганизация школьника',
      excerpt: 'Как научить ребенка планировать время, собирать портфель и делать уроки самостоятельно.',
      icon: 'CheckCircle'
    },
    {
      id: 10,
      category: '7-12 лет',
      title: 'Гаджеты и соцсети: правила безопасности',
      excerpt: 'Как контролировать экранное время и научить детей безопасному поведению в интернете.',
      icon: 'Smartphone'
    },
    {
      id: 11,
    ...
    },
    {
      id: 12,
      category: '12-16 лет',
      title: 'Как разговаривать с подростком о сложном',
      excerpt: 'Секс, алкоголь, наркотики — темы, которые нельзя игнорировать. Как вести диалог без морализаторства.',
      icon: 'MessageCircle'
    },
    {
      id: 13,
      category: '12-16 лет',
      title: 'Самооценка подростка: поддержка и границы',
      excerpt: 'Как помочь подростку принять себя и выстроить здоровую самооценку в мире соцсетей.',
      icon: 'Award'
    },
    {
      id: 14,
      category: '12-16 лет',
      title: 'Профориентация: помощь без давления',
      excerpt: 'Как поддержать подростка в выборе будущей профессии, не навязывая свои мечты.',
      icon: 'Compass'
    },
    {
      id: 15,
      category: '12-16 лет',
      title: 'Депрессия и тревожность у подростков',
      excerpt: 'Как распознать тревожные сигналы и когда нужна помощь специалиста. Поддержка без обесценивания.',
      icon: 'AlertTriangle'
    }
  ];
