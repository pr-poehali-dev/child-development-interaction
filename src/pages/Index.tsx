...
const Index = () => {
  ...
  const calculateTestResult = () => {
    ...
    if (aCount === 3) return { title: 'Осознанный родитель', desc: 'Вы отлично понимаете эмоциональные потребности ребенка и умеете выстраивать доверительные отношения!' };
    if (aCount >= 2) return { title: 'Внимательный родитель', desc: 'Вы на правильном пути! Продолжайте развивать эмоциональный интеллект вместе с ребенком.' };
    return { title: 'Развивающийся родитель', desc: 'У вас есть потенциал! Почитайте наши статьи о детской психологии для улучшения взаимопонимания.' };
  };
